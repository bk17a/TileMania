...
**Extension chosen:** Animated collectible coins, score system with on-screen display, multiple levels with scene transitions  
**Brief description of what you added:** Animated spinning coins placed throughout each level that the player can collect to earn points, displayed on a live score counter in the HUD. The game includes multiple levels connected through a level exit system with scene transitions, leading to a win screen upon completion.
...
Build a functional 2D platformer with a player that can move, jump, shoot, and interact with enemies and collectibles across multiple levels.

---

**2. How closely did your final game match your original prototype vision? What changed and why?**

It matched closely. The core gameplay loop was implemented as planned. Something that changed was using FMOD for my game music and I used the built in Unity audio for my sound effects.

---

**3. What is the most technically challenging thing you implemented? How did you solve it?**

The most challenging part was fixing the logic errors for the music and sound effects. I solved it by retracing my steps and added debugging comments to see where things went wrong.

---

**4. If you had one more week, what would you add or change?**

I would add a checkpoint system and a boss enemy with a health bar to make the game feel more complete and increase the difficulty curve.

---

**5. How does your approach to game development now compare to when you started the course?**

I now think more systematically about separating concerns between scripts and using prefabs and singletons to manage game state. I am much more comfortable debugging with the Console and understanding Unity's component-based architecture.
